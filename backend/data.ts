...
export const INITIAL_PROPERTIES: PublicProperty[] = [
  ...
  },
  {
    ...
    category: "Just Sold",
    valuation: "â‚¹7.5 Crore (Realized)",
...
export const REELS = [
  {
    id: "reel-1",
    title: "Inside the â‚¹12 Cr GMM Sovereignty Estate",
...
export const TESTIMONIALS = [
  {
    ...
    quote: "GMM Groups & Services redefined real estate procurement for me. Their advisory was incredibly data-centric, high-trust, and completely sovereign. I bought a penthouse worth â‚¹4.8 Cr through them with absolute ease and peace of mind.",
